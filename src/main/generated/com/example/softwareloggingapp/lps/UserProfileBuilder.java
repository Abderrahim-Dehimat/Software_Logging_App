...
public class UserProfileBuilder {
     ...
     *
     * @param operation
     * 		the operation type (e.g., READ, WRITE)
     * @param timestamp
    ...
    public UserProfileBuilder finalizeProfile() {
        this.primaryOperation = operationCounts.entrySet().stream().max(Map.Entry.comparingByValue()).map(Map.Entry::getKey).orElse("UNKNOWN");
        return this;
    }
