...
public class UserProfile {
     ...
     *
     * @param operation
     * 		The operation type to increment.
     */
    ...
    private void updatePrimaryOperation() {
        log.info("WRITE operation performed by user: " + authenticatedUserEmail);
        this.primaryOperation = this.operationCounts.entrySet().stream().max(Map.Entry.comparingByValue()).map(Map.Entry::getKey).orElse(null);// Sets to null if no operations exist.
